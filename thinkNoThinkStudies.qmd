...
In the Think/No-Think task, we compare the memory of pre-manipulation memorised words with after manipulation. This specific python [code]() was used for processing.
